...
def do_zip_update():
    ...
    if success:
        ...
        mesgdcrt.FailureMessage("Unable to update CMaxBomb.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/mdkausar295/CMaxBomb.git")
...
def do_git_update():
    ...
    if success:
        mesgdcrt.SuccessMessage("CMaxBomb was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update CMaxBomb.")
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/mdkausar295/CMaxBomb.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("CMaxBomb is up-to-date")
        mesgdcrt.GeneralMessage("Starting CMaxBomb")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("CMaxBomb was created by CMax-Kausar")
...
__CONTRIBUTORS__ = ['CMax-Kausar', 'anti-barbital', 'mumba', 'rabi-ebni-safi', 'TBomb']

ALL_COLORS = [Fore.GREEN, Fore.RED, Fore.YELLOW, Fore.BLUE,
              Fore.MAGENTA, Fore.CYAN, Fore.WHITE]
RESET_ALL = Style.RESET_ALL

description = """CMaxBomb - Your Friendly Spammer Application
...
parser = argparse.ArgumentParser(description=description,
                                 epilog='Coded by CMaxKausar !!!')
parser.add_argument("-sms", "--sms", action="store_true",
                    help="start CMaxBomb with SMS Bomb mode")
parser.add_argument("-call", "--call", action="store_true",
                    help="start CMaxBomb with CALL Bomb mode")
parser.add_argument("-mail", "--mail", action="store_true",
                    help="start CMaxBomb with MAIL Bomb mode")
parser.add_argument("-u", "--update", action="store_true",
                    help="update CMaxBomb")
parser.add_argument("-c", "--contributors", action="store_true",
                    help="show current CMaxBomb contributors")
parser.add_argument("-v", "--version", action="store_true",
                    help="show current CMaxBomb version")
